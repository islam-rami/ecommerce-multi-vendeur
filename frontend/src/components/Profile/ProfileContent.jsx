        ...
        <>
          <div className="flex justify-center w-full">
            <div className="relative">
              <img
                ...
                className="w-[150px] h-[150px] rounded-full object-cover border-[3px] border-[#fe7739]  "
                alt=""
              />
          ...
          <div className="w-full px-5">
            <form onSubmit={handleSubmit} aria-required={true}>
              ...
              <input
                className={`w-[250px] h-[40px] border border-[#fe7739] text-center text-[#fe7739] rounded-[3px] mt-8 cursor-pointer`}
                required
                value="Mettre à jour"
                type="submit"
              />
...
const AllOrders = () => {
  ...
  const columns = [
    { field: "id", headerName: "ID de commande", minWidth: 150, flex: 0.7 },
                  ...
                  <div className="w-full pb-2">
                    <label className="block pb-2">
                      ...
                      <span style={{ fontSize: "0.875rem", opacity: 0.6 }}>
                        (Numéro de bâtiment et de l'appartement)
                      </span>
                    </label>
      ...
      <div className="w-full">
        ...
        >
          ...
          <div className=" w-[100%] 800px:w-[50%] mt-2">
            ...
            />
            <input
              className={`w-[95%] h-[40px] border border-[#fe7739] text-center text-[#fe7739] rounded-[3px] mt-8 cursor-pointer`}
              required
              value="Update"
              type="submit"
            />
