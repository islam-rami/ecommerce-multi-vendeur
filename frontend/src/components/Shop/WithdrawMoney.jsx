...
const WithdrawMoney = () => {
  ...
  const withdrawHandler = async () => {
    ...
    if (withdrawAmount < 50 || withdrawAmount > Number(availableBalance) ) {
      ...
      console.log('ioooooooooooo',availableBalance - withdrawAmount);
    } else {
            ...
            {paymentMethod ? (
              <div>
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="pt-2">
                    <label>
                    Pays de la banque<span className="text-red-500">*</span>
                    </label>
                    <input
                      type="text"
                      name=""
                  ...
                  <div className="pt-2">
                    <label>
                    Code SWIFT de la banque <span className="text-red-500">*</span>
                    </label>
                    <input
                      type="text"
                      name=""
                      ...
                      placeholder="Entrez votre code SWIFT de banque !"
                      className={`${styles.input} mt-2`}
                    />
                  </div>
                  ...
                  <div className="pt-2">
                    ...
                    <input
                      ...
                      id=""
                      placeholder="Entrez le nom du titulaire de votre compte bancaire !"
                      className={`${styles.input} mt-2`}
                    />
                  </div>
                  ...
                  <div className="pt-2">
                    ...
                    <input
                      ...
                      placeholder="Entrez l'adresse de votre banque !"
                      className={`${styles.input} mt-2`}
                    />
                  </div>
                  ...
                  <div>
                    <div className="800px:flex w-full justify-between items-center">
                      <div className="800px:w-[50%]">
                        ...
                        <h5>Nom de la banque : {seller?.withdrawMethod.bankName}</h5>
                      </div>
                      <div className="800px:w-[50%]">
                        <AiOutlineDelete
                          size={25}
                    ...
                    <br />
                    <h4>Solde disponible :{availableBalance} €</h4>
                    <br />
