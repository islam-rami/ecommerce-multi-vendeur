...
const AllCoupons = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    await axios
      ...
      .then((res) => {
       toast.success("Code coupon créé avec succès!");
       setOpen(false);
       window.location.reload();
      })
      .catch((error) => {
      ...
      {isLoading ? (
        ...
        <div className="w-full mx-8 pt-1 mt-10 bg-white">
          <div className="w-full flex justify-end">
            ...
            >
              <span className="text-white">Créer un  codes de réduction</span>
            </div>
          </div>
          <DataGrid
            rows={row}
                ...
                <form onSubmit={handleSubmit} aria-required={true}>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder="Entrez la valeur de votre code promotionnel..."
                    />
                  </div>
                  <br />
                  <div>
                    ...
                    <input
                      ...
                      placeholder="Entrez le montant minimum de votre code promotionnel..."
                    />
                  </div>
                  <br />
                  <div>
                    ...
                    <input
                      ...
                      placeholder="Entrez le montant maximum de votre code promotionnel..."
                    />
                  </div>
                  <br />
